...
#T1.AP - first thoracic vertebra (T1) antero-posterior length
#T1.TR - first thoracic vertebra (T1) transverse length
# ...
#L1.AP - first lumbar vertebra (L1) antero-posterior length
#L1.TR - first lumbar vertebra (L1) transverse length
