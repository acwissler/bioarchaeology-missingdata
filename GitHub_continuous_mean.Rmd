####Mean Imputation of Continuous variables####
...
*method="mean"* sets the code for mean imputation
...
write.csv(ab, file="PE.cont.mean.csv")
```
...
df.cont.mean<-data.frame(rbind(aa, ab, ac, ad, ae))
colnames(df.cont.mean)<-c("FL.Left", "FL.Right", "T1.AP", "T1.TR", "T5.AP", "T5.TR", "T10.AP", "T10.TR", "L1.AP", "L1.TR", "L3.AP", "L3.TR")
rownames(df.cont.mean)<-c("five_one_imp", "five_two_imp", "five_three_imp", "five_four_imp", "five_five_imp")
write.csv(df.cont.mean, file="nrmse.continuous.mean.csv")
```