####Predictive Mean Matching Imputation of Continuous variables####
...
write.csv(ab, file="PE.cont.pmm.csv")
```
...
rownames(df.cont.pmm)<-c("five_one_imp", "five_two_imp", "five_three_imp", "five_four_imp", "five_five_imp")
write.csv(df.cont.pmm, file="nrmse.continuous.pmm.csv")
```