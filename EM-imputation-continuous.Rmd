##################
#This file imputes missing values of continuous data using Expectation Maximization
#This example uses an anthropological dataset that has 5% missing data
#Examines the success of Expectation Maximization against the complete dataset
#################
...
#Using the 'missMethods' package and the impute_EM function
#"If stochastic = TRUE, residuals from a multivariate normal distribution are added to these expected values"
#Create 5 versions of each totalling 25
#Then average those values and bring it back to 5 imputed datasets
