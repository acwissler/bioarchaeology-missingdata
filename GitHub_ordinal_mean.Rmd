####Mean Imputation of Ordinal variables####
...
```{r}
tempdata.five.1<-mice(ord.five.1, m=10, maxit=50, method="mean", seed=1)
tempdata.five.2<-mice(ord.five.2, m=10, maxit=50, method="mean", seed=1)
tempdata.five.3<-mice(ord.five.3, m=10, maxit=50, method="mean", seed=1)
tempdata.five.4<-mice(ord.five.4, m=10, maxit=50, method="mean", seed=1)
tempdata.five.5<-mice(ord.five.5, m=10, maxit=50, method="mean", seed=1)
```
...
write.csv(ab, file="PE.ord.mean.practice.csv")
```
...
write.csv(df.ord.mean, file="nrmse.ordinal.mean.practice.csv")
```